  ...
  fanFields: [
    {
      ...
      target: { kind: "edge", startAnchorId: "anchor-p1-top", endAnchorId: "anchor-p4-top" },
      distribution: { mode: "count", count: 3 },
      reversed: false,
      elevationRule: { kind: "linear" },
      memberTemplate: { sectionId: "sec-rafter", materialId: "mat-1", rollRad: 0 },
      memberIds: ["member-fan-a-1", "member-fan-a-2", "member-fan-a-3"],
    },
    {
      id: "fan-field-b",
      sourceAnchorId: "anchor-ha3",
      target: { kind: "edge", startAnchorId: "anchor-p2-top", endAnchorId: "anchor-p5-top" },
      distribution: { mode: "count", count: 3 },
      reversed: false,
      elevationRule: { kind: "linear" },
      memberTemplate: { sectionId: "sec-rafter", materialId: "mat-1", rollRad: 0 },
